...
{	
    ...
    $output .= '<p><select id="smile_'.$input_name.'-type" class="cp-grad-'.$uid.' form-control smile-input smile-select cp-gradient-type" name="'.$input_name.'-type" >';
	...
	$output .= '<p><input type="text" id="smile_'.$input_name.'_one" data-default-color="'.$first_color.'" class="cs-wp-color-picker smile-input smile-'.$type.'_one '.$input_name.'_one '.$type.'_one '.$class.'" name="' . $input_name . '_one" value="'.$first_color.'"  /></p>';

	//Sec color
	$output .= '<p><strong><label>Second Color</label></strong></p>';
	$output .= '<p><input type="text" id="smile_'.$input_name.'_sec" data-default-color="'.$sec_color.'" class="cs-wp-color-picker smile-input smile-'.$type.'_sec '.$input_name.'_sec '.$type.'_sec '.$class.'" name="' . $input_name . '_sec" value="'.$sec_color.'"  /></p>';

	 // Gradient Direction
    $output .= '<p><strong><label>Gradient Direction </label></strong></p>';
    $output .= '<p><select id="smile_'.$input_name.'-direction" class="cp-grad-'.$uid.' form-control smile-input cp-gradient-direction smile-select" name="'.$input_name.'-direction" >';
    ...
    $output .= '<div class="text-1 slider-input '.$tooltipClass.'"><input id="smile_'.$grad_input.'_'.$uid.'" type="number"  step="'.$step.'" class="form-control smile-input smile-'.$grad_type.' '.$grad_input.' '.$grad_type.' '.$class.'" name="' . $grad_input . '" value="'.$first_deg.'" data-min="'.$min.'" data-max="'.$max.'" min="'.$min.'" max="'.$max.'" data-step="'.$step.'"  ></div></div>';

    $output .= '<div id="slider_'.$grad_input.'_'.$uid.'" class="slider-bar large ui-slider ui-slider-horizontal ui-widget ui-widget-content '.$grad_input.' '.$grad_type.' '.$class.'"><a class="ui-slider-handle ui-state-default" href="#"></a><span class="range-quantity" ></span></div></div>';
    ...
    $output .= '<div class="text-1 slider-input '.$tooltipClass.'"><input id="smile_'.$grad_sec_input.'_'.$uid.'" type="number"  step="'.$step.'" class="form-control smile-input smile-'.$grad_type.' '.$grad_sec_input.' '.$grad_type.' '.$class.'" name="' . $grad_sec_input . '" value="'.$sec_deg.'" data-min="'.$min.'" data-max="'.$max.'" min="'.$min.'" max="'.$max.'" data-step="'.$step.'"  ></div></div>';

    $output .= '<div id="slider_'.$grad_sec_input.'_'.$uid.'" class="slider-bar large ui-slider ui-slider-horizontal ui-widget ui-widget-content '.$grad_sec_input.' '.$grad_type.' '.$class.'"><a class="ui-slider-handle ui-state-default" href="#"></a><span class="range-quantity" ></span></div></div>';   
