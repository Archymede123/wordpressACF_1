...
function cp_modal_global_before_init( $a ) {
	...
	//	Time Zone		
	$timezone_name = $convert_plug_settings['cp-timezone'];
	...
	$cp_modal_visibility	= apply_filters( 'cp_module_visibility', $a['hide_on_device'] ); 		//	Visibility on Browser, Devices & OS
	...
	$overlay_show_data .= $cp_modal_visibility.' ';
