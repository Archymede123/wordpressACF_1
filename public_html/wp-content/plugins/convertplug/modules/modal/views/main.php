            ...
            <thead>
               <tr>
                <th scope="col" id="style-name" class="manage-column column-style <?php echo $sortingStyleNameClass; ?>">
                  <a rel="noopener" href="?page=smile-modal-designer&orderby=style_name&<?php echo $orderLink; ?>&sq=<?php echo $searchKey; ?>&cont-page=<?php echo $page; ?>">
                 <span class="connects-icon-trash"></span>
                   <?php _e( "Delete Modal", "smile" ); ?></a></th>
                 <th scope="col" id="style-name" class="manage-column column-style <?php echo $sortingStyleNameClass; ?>">
        ...
        <div class="row">
          <div class="container" style="max-width:100% !important;width:100% !important;">
            <div class="col-sm-6">
              ...
              <a class="button-primary action-tooltip cp-delete-multiple-modal-style" href="#" title="" data-delete="hard" data-option="smile_modal_styles" data-id = "" data-variantoption = "modal_variant_tests" >
