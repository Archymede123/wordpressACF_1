        ...
        <div class="row">
          <div class="container" style="max-width:100% !important;width:100% !important;">
            <div class="col-sm-6">
              ...
              <a class="button-primary action-tooltip cp-delete-multiple-modal-style" href="#" title="" data-delete="hard" data-option="smile_slide_in_styles" data-id = "" data-variantoption = "slide_in_variant_tests" >
                  <?php _e( "Delete Selected SlideIn", "smile" ); ?>
              </a>   
            </div><!-- .col-sm-6 -->
            <div class="col-sm-6">
              <?php
