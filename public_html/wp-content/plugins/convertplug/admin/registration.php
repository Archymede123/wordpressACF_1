    ...
    <div class="bend-content-wrap">
      ...
      <div class="container cp-welcome-bottom-content">
        <div class="col-md-4 col-md-offset-4">
          <a rel="noopener" target="_blank" class="button-primary cp-welcome-started" href="<?php get_admin_url() ?>index.php?page=bsf-registration"><?php _e( "LET'S GET STARTED", "smile" ); ?></a>
        </div>
