<?php 
	if(isset($_REQUEST['imtst_submit'])) imtst_save_update_metas_vc();
	$metas = imtst_general_settings_meta_vc();
?>
       ...
       <div class="stuffbox">
		...
		<div class="stuffbox">
                    ...
                    <div class="inside">
                        <table class="form-table indeed_admin_table">
        	                <tbody>
                                <tr>
                                    ...
                                    <td>
										<input type="text" value="<?php echo IMTST_POST_TYPE_VC;?>" id="imtst_post_type_name" style="min-width: 300px;"/>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="submit">
                            <input type="button" onClick="imtst_change_post_type_name_vc('<?php echo get_site_url();?>');" value="<?php echo __('Save changes', 'imtst');?>" name="imtst_submit" class="button button-primary button-large" />
                        </div>
                    </div>
		</div>	
</div>
