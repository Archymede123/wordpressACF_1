		...
		<div id="content" class="site-content" role="main">		
			<div class="imtst_inside_page ictst_wrapp">
				...
				<div class="imtst_item_details">
					...
					<div class="imtst_stars"><?php echo imtst_return_stars_vc($str['rating']);?></div>	
				</div>
				<div class="imtst_clear"></div>
				<div class="imtst_quote"><?php echo $str['quote'];?></div>
				<?php 
					#RICH SNIPPETS
					$data = imtst_general_settings_meta_vc();
					if(isset($data['imtst_rich_snippets']) && $data['imtst_rich_snippets']==1){
						...
						echo imtst_return_google_rich_snippets_vc($rich_arr,'single');						
					}
				?>				
				<div class="imtst_clear"></div>
			</div>
