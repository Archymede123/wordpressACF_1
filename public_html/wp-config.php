...
define( 'ERRORLOGFILE', '/wp_errorlogfile.log' ); // Added by SecuPress.
...
define('DB_NAME', 'mybrlkxh_wordpress');

/** Utilisateur de la base de données MySQL. */
define('DB_USER', 'mybrlkxh_wordpre');

/** Mot de passe de la base de données MySQL. */
define('DB_PASSWORD', '%B22R7uJ)R{]');
